...
export default function Book({bookAuthor, setBookAuthor, bookColor, setBookColor, bookPages, setBookPages}) {
  return (
    <>
      <TextField variant="standard" sx={{ marginTop: 2, width: '100%' }} value={bookAuthor} type="text" label='ENTER AUTHOR NAME' onChange={(e) => setBookAuthor(e.target.value)}></TextField>
